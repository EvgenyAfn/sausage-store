pipeline {
    ...
    post {
        success {
            sh """curl -X POST -H 'Content-type: application/json' --data '{"chat_id": "-1002100383038", "text": "Evgeniy Afanasiev на выходных собрал крутое приложение." }' https://api.telegram.org/bot5933756043:AAE8JLL5KIzgrNBeTP5e-1bkbJy4YRoeGjs/sendMessage"""}
    }
}